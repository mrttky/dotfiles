...
var require_main2 = __commonJS((exports2) => {
  __export(exports2, {
    ...
    TextDocumentEdit: () => TextDocumentEdit3,
  ...
  })(TextDocumentEdit3 || (TextDocumentEdit3 = {}));
  var CreateFile;
...
function isSnippetEdit(action) {
  var _a, _b;
  for (const edit of (_b = (_a = action.edit) == null ? void 0 : _a.documentChanges) != null ? _b : []) {
    if (import_vscode_languageserver_protocol.TextDocumentEdit.is(edit)) {
      if (edit.edits.some((indel) => indel.insertTextFormat === import_vscode_languageserver_protocol.InsertTextFormat.Snippet)) {
        return true;
      }
    }
  }
    ...
    middleware: {
      async provideCodeActions(document2, range, context, token) {
        ...
        for (const item of values) {
          ...
          result.push(import_vscode_languageserver_protocol.CodeAction.create(item.title, command));
        }
        return result;
      }
    },
